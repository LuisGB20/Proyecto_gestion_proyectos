    ...
    return (
        <>
            ...
            <ul className='my-10 mx-auto'>
                ...
                <li className='mx-auto text-center my-10 mt-80'><Link className='font-medium text-center text-lg italic mx-auto hover:bg-gradient-to-r hover:from-[#1E4C6A]  hover:to-[#1B7FC5] p-4 rounded-lg hover:text-white' to="/">Cerras Sesión</Link></li>
            </ul>
        </div>
        </>
    )
