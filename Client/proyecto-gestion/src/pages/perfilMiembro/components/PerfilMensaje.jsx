...
function PerfilMensaje() {
  return (
    <div className='w-full h-full'>
      <div className='w-11/12 mx-auto rounded-lg flex flex-col sm:flex-row my-10'>
        <img src={perfil} className='w-1/4 h-1/4 mx-auto rounded-full' alt='Perfil' />
        <div className='w-full sm:w-1/2 mx-auto bg-white rounded-3xl'>
      ...
      <div className='w-full mx-auto flex flex-col sm:flex-row my-3'>
        <div className='w-full sm:w-1/2 h-full my-10'>
          <h1 className='font-sans italic my-auto text-xl mx-4 sm:mx-20 '>Ultimas Tareas completadas</h1>
          <div className='border-2 w-10/12 bg-white mx-auto rounded-lg flex my-3'>
            <img src={rectangulo} className='ml-4 w-28 h-28 m-auto' alt='Tarea' />
