  ...
  return (
    <>
      <div className='border-2 w-11/12 mx-auto rounded-lg flex flex-col sm:flex-row my-3'>
        ...
        <p className='text-center text-md w-full sm:w-1/4 mx-auto font-semibold italic my-auto sm:my-0 sm:mr-3'>Infraestructura De Red Y Servidores</p>
...
export default TarjetasServidores;