...
function TarjetasEquipo() {
  return (
    <div className='bg-white'>
      <img src={imagenEquipo} className='rounded-xl w-96 my-3 mx-auto' alt='Imagen del equipo' />
      <div className='my-3 mx-3'>
        ...
        <p className='text-left text-lg font-normal'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique, dolorem eveniet maxime nostrum a assumenda
          laborum vel harum nesciunt quidem, ea architecto ipsum. Labore quo rerum nam nihil assumenda ab.
        </p>
      </div>
      <div>
