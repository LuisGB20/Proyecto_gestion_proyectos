          ...
          <div className='flex'>
            ...
            <div className='w-1/2'>
              ...
              <div className='flex mb-8 p-4 mr-8 ml-8 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.20)]'>
                <div>
                  <img src={TeamProyecto} className='ml-2' alt='Equipo de Computo' />
                </div>
              ...
              <div className='flex mb-8 p-4 mr-8 ml-8 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.20)]'>
                <div>
                  <img src={ServidorProyecto} className='ml-2' alt='Servidor' />
                </div>
                <div className='flex items-center ml-8 '>Servidor</div>
              </div>
              <div className='flex mb-8 p-4 mr-8 ml-8 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.20)]'>
                <div>
                  <img src={Financiamiento} className='ml-2' alt='Financiamiento' />
                </div>
